...
function editItem(btn) {
    ...
    toolbarHTML = toolbarHTML + "<div id='toolBarId' class = 'toolBar'><div>" +
        ...
        "<button data-title='adminEditDiv Paragraph type-2 with white Background' type='button' class='itmUpdBtnSmall btn btn-primary' onclick=addComponent('" + itemid + "','adminEditDiv') >Ad</button>" +
...
function updateInfoItem(itemid, createNewItem) {
    ...
    var StrFunction = "UpdateInfoItem";
