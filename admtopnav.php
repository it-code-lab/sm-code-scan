...
<div class="topnav" id="myTopnav">
      ...
      <!-- ****SM-TO-SMADM******* -->
      <?php if (isset($_SESSION['smusr']) && $_SESSION['smusr']): ?>
         <a id="admLinkId" class="navLink displayNone"
                  href="javascript:showIntQsPage()">Interview Questions</a>

         <!-- <a id="admLinkId" class="navLink dropDownNav displayNone" href="">MANAGE <i
                  class="fa fa-caret-down"></i></a>
            <div class="dropdown-content">
               <a id="intQLinkId" class="navLink displayNone"
                  href="javascript:showIntQsPage()">Interview Questions</a>
            </div> -->
